...
goog.i18n.pluralRules.get_vf_ = function(n, opt_precision) {
  ...
  /** @const */ var base = Math.pow(10, v);
  /** @const */ var f = (n * base | 0) % base;
  return {v:v, f:f};
};
/**
 * @private
...
goog.i18n.pluralRules.filSelect_ = function(n, opt_precision) {
  /** @const */ var i = n | 0;
  /** @const */ var vf = goog.i18n.pluralRules.get_vf_(n, opt_precision);
...
goog.i18n.pluralRules.daSelect_ = function(n, opt_precision) {
  /** @const */ var i = n | 0;
  /** @const */ var vf = goog.i18n.pluralRules.get_vf_(n, opt_precision);
  /** @const */ var wt = goog.i18n.pluralRules.get_wt_(vf.v, vf.f);
