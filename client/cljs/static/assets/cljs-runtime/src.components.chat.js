...
src.components.chat.create_msg = (function src$components$chat$create_msg(p__38306,msg){
...
var nick_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38307__$1,new cljs.core.Keyword(null,"nick-name","nick-name",-706954142));
var avatar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38307__$1,new cljs.core.Keyword(null,"avatar","avatar",-1607499307));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("src.components.chat","send-msg","src.components.chat/send-msg",-1359274626),(function (p__38309,p__38310){
var map__38311 = p__38309;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__38312 = p__38310;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38312,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38312,(1),null);
...
var G__38316_38331 = new cljs.core.Keyword("src.components.chat","dispatch!","src.components.chat/dispatch!",-705550250);
var G__38317_38332 = (function (msg){
return src.tube.push.cljs$core$IFn$_invoke$arity$2(src.components.chat.tube_event_type,src.sundry.__GT_js(msg));
});
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__38316_38331,G__38317_38332) : re_frame.core.reg_fx.call(null,G__38316_38331,G__38317_38332));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("src.components.chat","populate-msg","src.components.chat/populate-msg",-947512042),(function (db,p__38318){
var vec__38319 = p__38318;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38319,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38319,(1),null);
...
var G__38322_38333 = new cljs.core.Keyword("src.components.chat","chat-history","src.components.chat/chat-history",-1875606148);
var G__38323_38334 = (function (db){
return new cljs.core.Keyword(null,"chat-history","chat-history",912746146).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__38322_38333,G__38323_38334) : re_frame.core.reg_sub.call(null,G__38322_38333,G__38323_38334));
src.components.chat.receive_msg = (function src$components$chat$receive_msg(resp){
var G__38324 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("src.components.chat","populate-msg","src.components.chat/populate-msg",-947512042),src.sundry.__GT_clj(resp)], null);
return (src.sundry._GT_evt.cljs$core$IFn$_invoke$arity$1 ? src.sundry._GT_evt.cljs$core$IFn$_invoke$arity$1(G__38324) : src.sundry._GT_evt.call(null,G__38324));
});
...
var G__38326_38335 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("src.components.chat","send-msg","src.components.chat/send-msg",-1359274626),cljs.core.deref(value)], null);
(src.sundry._GT_evt.cljs$core$IFn$_invoke$arity$1 ? src.sundry._GT_evt.cljs$core$IFn$_invoke$arity$1(G__38326_38335) : src.sundry._GT_evt.call(null,G__38326_38335));

return cljs.core.reset_BANG_(value,"");
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.no-resize.chat-input.col-9","input.no-resize.chat-input.col-9",-1349278760),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Type your msg...",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__38325_SHARP_){
return cljs.core.reset_BANG_(value,src.sundry.__GT_input(p1__38325_SHARP_));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38330),src$components$chat$history_$_iter__38327(cljs.core.chunk_rest(s__38328__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38330),null);
}
} else {
var msg = cljs.core.first(s__38328__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"src","src",-1651076051),new cljs.core.Keyword(null,"avatar","avatar",-1607499307).cljs$core$IFn$_invoke$arity$1(msg)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),[" by ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"nick-name","nick-name",-706954142).cljs$core$IFn$_invoke$arity$1(msg))].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),[" at ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(src.sundry.epoch__GT_local.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"publish-time","publish-time",-192527312).cljs$core$IFn$_invoke$arity$1(msg),true))].join('')], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid())], null)),src$components$chat$history_$_iter__38327(cljs.core.rest(s__38328__$2)));
}
} else {
return null;
}
