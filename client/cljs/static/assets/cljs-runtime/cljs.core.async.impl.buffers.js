...
cljs.core.async.impl.buffers.acopy = (function cljs$core$async$impl$buffers$acopy(src__$1,src_start,dest,dest_start,len){
var cnt = (0);
while(true){
if((cnt < len)){
(dest[(dest_start + cnt)] = (src__$1[(src_start + cnt)]));
...
var v_32548 = this$.pop();
if((keep_QMARK_.cljs$core$IFn$_invoke$arity$1 ? keep_QMARK_.cljs$core$IFn$_invoke$arity$1(v_32548) : keep_QMARK_.call(null,v_32548))){
this$.unshift(v_32548);
} else {
}
