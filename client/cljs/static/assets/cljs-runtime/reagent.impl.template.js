...
var G__8041 = o;
goog.object.set(G__8041,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__8077__i < G__8077__a.length) {G__8077__a[G__8077__i] = arguments[G__8077__i + 0]; ++G__8077__i;}
  args = new cljs.core.IndexedSeq(G__8077__a,0,null);
} 
...
var G__8046 = o;
goog.object.set(G__8046,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__8081__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__8081 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__8082__i = 0, G__8082__a = new Array(arguments.length -  0);
while (G__8082__i < G__8082__a.length) {G__8082__a[G__8082__i] = arguments[G__8082__i + 0]; ++G__8082__i;}
  args = new cljs.core.IndexedSeq(G__8082__a,0,null);
} 
return G__8081__delegate.call(this,args);};
G__8081.cljs$lang$maxFixedArity = 0;
G__8081.cljs$lang$applyTo = (function (arglist__8083){
var args = cljs.core.seq(arglist__8083);
return G__8081__delegate(args);
});
...
var G__8047 = props;
var G__8047__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8047,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8047);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8047__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__8047__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8049 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8049,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8049;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__8052){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8053__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__8055_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__8055_SHARP_);
}));
} else {
return null;
}
...
var vec__8057 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8057,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8057,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8057,(2),null);
...
var temp__5739__auto___8121 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___8121 == null)){
} else {
var key_8122 = temp__5739__auto___8121;
(jsprops.key = key_8122);
}
...
var temp__5739__auto___8124 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___8124 == null)){
} else {
var key_8127 = temp__5739__auto___8124;
(jsprops.key = key_8127);
}
...
var G__8061 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__8061) : reagent.impl.template.as_element.call(null,G__8061));
} else {
var temp__5739__auto___8136 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___8136 == null)){
} else {
var key_8137 = temp__5739__auto___8136;
(jsprops.key = key_8137);
}
...
var G__8063 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__8063)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__8063)){
return x;
} else {
...
var len__4789__auto___8138 = arguments.length;
var i__4790__auto___8139 = (0);
while(true){
if((i__4790__auto___8139 < len__4789__auto___8138)){
args__4795__auto__.push((arguments[i__4790__auto___8139]));

var G__8140 = (i__4790__auto___8139 + (1));
i__4790__auto___8139 = G__8140;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8064){
var G__8065 = cljs.core.first(seq8064);
var seq8064__$1 = cljs.core.next(seq8064);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8065,seq8064__$1);
}));
...
break;
default:
var G__8142 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__8142;
continue;
...
var ctx = ({});
var vec__8068 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8068,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8068,(1),null);
...
var G__8071 = (cljs.core.count(argv) - first_child);
switch (G__8071) {
case (0):
