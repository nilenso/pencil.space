...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__36202){
...
var request = map__36203__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36203__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__36209 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__36209.cljs$core$IFn$_invoke$arity$1 ? fexpr__36209.cljs$core$IFn$_invoke$arity$1(response) : fexpr__36209.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__36210 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__36210.cljs$core$IFn$_invoke$arity$1 ? fexpr__36210.cljs$core$IFn$_invoke$arity$1(response) : fexpr__36210.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__36211){
...
var request = map__36212__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36212__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
