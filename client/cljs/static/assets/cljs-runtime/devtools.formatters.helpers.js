...
var G__7211 = devtools.prefs.pref(v);
v = G__7211;
continue;
} else {
return v;
...
}catch (e7194){var _e__6394__auto__ = e7194;
return false;
}})();
...
}catch (e7199){var _e__6394__auto__ = e7199;
return false;
}})();
...
}catch (e7201){var _e__6394__auto__ = e7201;
return false;
}}
}
});
...
var vec__7203 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7203,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7203,(1),null);
...
return cljs.core.some((function (p1__7206_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__7206_SHARP_);
}),template);
});
