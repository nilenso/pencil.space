...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__12244 = cljs.core.get_global_hierarchy;
return (fexpr__12244.cljs$core$IFn$_invoke$arity$0 ? fexpr__12244.cljs$core$IFn$_invoke$arity$0() : fexpr__12244.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__12268){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12269__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12269__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__12274 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12274,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12274,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__12283 = cljs.core.get_global_hierarchy;
...
var map__12292 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__12292__$1 = (((((!((map__12292 == null))))?(((((map__12292.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12292.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12292):map__12292);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12292__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12292__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__12298){
var vec__12299 = p__12298;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12299,(0),null);
var map__12302 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12299,(1),null);
var map__12302__$1 = (((((!((map__12302 == null))))?(((((map__12302.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12302.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12302):map__12302);
var schema = map__12302__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12302__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__12312 = cljs.core.get_global_hierarchy;
return (fexpr__12312.cljs$core$IFn$_invoke$arity$0 ? fexpr__12312.cljs$core$IFn$_invoke$arity$0() : fexpr__12312.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__12317(s__12318){
return (new cljs.core.LazySeq(null,(function (){
var s__12318__$1 = s__12318;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__12318__$1);
if(temp__5735__auto__){
var s__12318__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12318__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__12318__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__12320 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__12319 = (0);
while(true){
if((i__12319 < size__4581__auto__)){
var vec__12321 = cljs.core._nth(c__4580__auto__,i__12319);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12321,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12321,(1),null);
cljs.core.chunk_append(b__12320,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12320),spec_tools$swagger$core$iter__12317(cljs.core.chunk_rest(s__12318__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12320),null);
}
} else {
var vec__12324 = cljs.core.first(s__12318__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12324,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12324,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__12317(cljs.core.rest(s__12318__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__12327){
var vec__12328 = p__12327;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12328,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12328,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__12331,p){
var vec__12332 = p__12331;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12332,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12332,(1),null);
var acc__$1 = vec__12332;
