...
if((x instanceof cljs.core.Keyword)){
var G__10716 = spec;
var G__10717 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__10716,G__10717) : f.call(null,G__10716,G__10717));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__10719 = spec;
var G__10720 = spec_tools.transform.keyword__GT_string(spec,x);
...
}catch (e10721){if((e10721 instanceof Error)){
var ___$1 = e10721;
return x;
} else {
throw e10721;
...
}catch (e10722){if((e10722 instanceof Error)){
var ___$1 = e10722;
return x;
} else {
throw e10722;
...
}catch (e10729){if((e10729 instanceof Error)){
var ___$1 = e10729;
return x;
} else {
throw e10729;
...
}catch (e10734){if((e10734 instanceof Error)){
var ___$1 = e10734;
return x;
} else {
throw e10734;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__10742,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10743__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__10745,x){
var map__10746 = p__10745;
var map__10746__$1 = (((((!((map__10746 == null))))?(((((map__10746.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10746.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10746):map__10746);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10746__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__10748,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10749__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
