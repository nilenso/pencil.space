...
goog.i18n.currency.getGlobalCurrencyPattern = function(currencyCode) {
  /** @const */ var info = goog.i18n.currency.CurrencyInfo[currencyCode];
  /** @const */ var patternNum = info[0];
...
goog.i18n.currency.getCurrencyPattern_ = function(patternNum, sign) {
  /** @const */ var strParts = ["#,##0"];
  /** @const */ var precision = patternNum & goog.i18n.currency.PRECISION_MASK_;
  if (precision > 0) {
    strParts.push(".");
...
goog.i18n.currency.adjustPrecision = function(pattern, currencyCode) {
  ...
  /** @const */ var precision = info[0] & goog.i18n.currency.PRECISION_MASK_;
  if (precision > 0) {
    strParts.push(".");
    for (var i = 0; i < precision; i++) {
      strParts.push("0");
...
/** @const @type {!Object<?,!Array<?>>} */ goog.i18n.currency.CurrencyInfo = {"AED":[2, "dh", "د.إ."], "ALL":[0, "Lek", "Lek"], "AUD":[2, "$", "AU$"], "BDT":[2, "৳", "Tk"], "BGN":[2, "lev", "lev"], "BRL":[2, "R$", "R$"], "CAD":[2, "$", "C$"], "CDF":[2, "FrCD", "CDF"], "CHF":[2, "CHF", "CHF"], "CLP":[0, "$", "CL$"], "CNY":[2, "¥", "RMB¥"], "COP":[32, "$", "COL$"], "CRC":[0, "₡", "CR₡"], "CZK":[50, "Kč", "Kč"], "DKK":[50, "kr.", "kr."], "DOP":[2, "RD$", "RD$"], "EGP":[2, "£", "LE"], "ETB":[2, "Birr", 
"Birr"], "EUR":[2, "€", "€"], "GBP":[2, "£", "GB£"], "HKD":[2, "$", "HK$"], "HRK":[2, "kn", "kn"], "HUF":[34, "Ft", "Ft"], "IDR":[0, "Rp", "Rp"], "ILS":[34, "₪", "IL₪"], "INR":[2, "₹", "Rs"], "IRR":[0, "Rial", "IRR"], "ISK":[0, "kr", "kr"], "JMD":[2, "$", "JA$"], "JPY":[0, "¥", "JP¥"], "KRW":[0, "₩", "KR₩"], "LKR":[2, "Rs", "SLRs"], "LTL":[2, "Lt", "Lt"], "MNT":[0, "₮", "MN₮"], "MVR":[2, "Rf", "MVR"], "MXN":[2, "$", "Mex$"], "MYR":[2, "RM", "RM"], "NOK":[50, "kr", "NOkr"], "PAB":[2, "B/.", "B/."], 
"PEN":[2, "S/.", "S/."], "PHP":[2, "₱", "PHP"], "PKR":[0, "Rs", "PKRs."], "PLN":[50, "zł", "zł"], "RON":[2, "RON", "RON"], "RSD":[0, "din", "RSD"], "RUB":[50, "₽", "RUB"], "SAR":[2, "Rial", "Rial"], "SEK":[50, "kr", "kr"], "SGD":[2, "$", "S$"], "THB":[2, "฿", "THB"], "TRY":[2, "₺", "TRY"], "TWD":[2, "NT$", "NT$"], "TZS":[0, "TSh", "TSh"], "UAH":[2, "грн.", "UAH"], "USD":[2, "$", "US$"], "UYU":[2, "$", "$U"], "VND":[48, "₫", "VN₫"], "YER":[0, "Rial", "Rial"], "ZAR":[2, "R", "ZAR"]};
...
"SSP":[2, "£", "SSP"], "STD":[0, "Db", "Db"], "SYP":[0, "£", "SY£"], "SZL":[2, "SZL", "SZL"], "TJS":[2, "Som", "TJS"], "TMT":[50, "m", "TMT"], "TND":[3, "din", "DT"], "TOP":[2, "T$", "T$"], "TTD":[2, "$", "TT$"], "UGX":[0, "UGX", "UGX"], "UZS":[0, "soʼm", "UZS"], "VEF":[2, "Bs", "Bs"], "VES":[2, "Bs", "Bs"], "VUV":[0, "VUV", "VUV"], "WST":[2, "WST", "WST"], "XAF":[0, "FCFA", "FCFA"], "XCD":[2, "$", "EC$"], "XOF":[0, "CFA", "CFA"], "XPF":[48, "FCFP", "FCFP"], "ZMW":[0, "ZMW", "ZMW"], "ZWD":[0, "$", 
"Z$"]};
