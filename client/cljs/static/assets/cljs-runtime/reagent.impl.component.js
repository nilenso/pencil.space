...
if((i < len)){
var k = (ks[i]);
var G__8030 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__8031 = (i + (1));
m = G__8030;
i = G__8031;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__7946 = c;
var G__7946__$1 = (((G__7946 == null))?null:G__7946.prototype);
if((G__7946__$1 == null)){
return null;
} else {
return G__7946__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__7950 = c;
var G__7950__$1 = (((G__7950 == null))?null:G__7950.prototype);
if((G__7950__$1 == null)){
return null;
} else {
return G__7950__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__8037__delegate = function (args){
var G__7957 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__7957) : reagent.impl.component.as_element.call(null,G__7957));
};
...
var G__7958 = c;
var G__7958__$1 = (((G__7958 == null))?null:G__7958.constructor);
if((G__7958__$1 == null)){
return null;
} else {
return G__7958__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__7961 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__7962 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__7962);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__7961);
}});
...
var c = this;
var G__7972_8048 = goog.object.get(c,"cljsRatom");
if((G__7972_8048 == null)){
} else {
reagent.ratom.dispose_BANG_(G__7972_8048);
}
...
var renders_8050 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_8051 = cljs.core.first(cljs.core.vals(renders_8050));
...
if((cljs.core.count(renders_8050) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_8050))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_8051)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_8051], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__7973 = o;
goog.object.set(G__7973,cljs.core.name(k),v);
